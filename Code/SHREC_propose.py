...
if __name__ == "__main__":
    ...
    # # #
    # test_DRGs = []
    # for data0 in test_data_point_clouds:
    #     function0 = p_eccentricity_VR(data0, 100)
    #     DRG0 = DecoratedReebGraph(data=data0, function=function0)
    #     DRG0.fit_Vietoris_Rips()
    #     DRG0.fit_Reeb()
    #     # DRG0.fit_diagrams(persistence_images=True, birth_range=birth_range, pixel_size=pixel_size,
    #     #                   kernel_params=kernel_params)
    #     test_DRGs.append(DRG0)
    # #
    ...
    # with open("train_DRGs_shrec.pkl", "wb") as f:
    #     pickle.dump({"DRGs": train_DRGs, "labels": train_labels}, f)
    # with open("test_DRGs_shrec.pkl", "wb") as f:
