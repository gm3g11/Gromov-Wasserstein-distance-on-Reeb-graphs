...
if __name__ == "__main__":
    ...
    # # # #
    # train_data_point_clouds = full_dataset['train_points']
    # test_data_point_clouds = full_dataset['test_points']
    # # # #
    # train_labels = full_dataset['train_labels']
    ...
    # kernel_params = {'sigma': [[0.00001, 0.0], [0.0, 0.00001]]}
    # # # #
    # train_DRGs, train_time, train_invalid = preprocess_to_DRG(train_data_point_clouds)
    # test_DRGs, test_time, test_invalid = preprocess_to_DRG(test_data_point_clouds)
    #
    #
    # # #
    ...
    # with open("train_DRGs_shrec_decorated.pkl", "wb") as f:
    #     pickle.dump({"DRGs": train_DRGs, "labels": train_labels}, f)
    # with open("test_DRGs_shrec_decorated.pkl", "wb") as f:
    #     pickle.dump({"DRGs": test_DRGs, "labels": test_labels}, f)
    # #
    # # print("Saved preprocessed train and test DRGs to disk.")

    train_file = "train_DRGs_shrec_decorated.pkl"
    test_file = "test_DRGs_shrec_decorated.pkl"
    ...
    accuracies, eval_time = evaluate_knn(test_DRGs[:10], train_DRGs, train_labels, test_labels[:10], k_values)
